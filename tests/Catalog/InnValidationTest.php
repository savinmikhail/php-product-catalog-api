...
use App\Shared\Http\HttpTransportException;
...
final class InnValidationTest extends TestCase
{
    public function testInnValidationCacheExpiresEntriesAfterTtl(): void
    {
        ...
        $cache = new TtlInnValidationCache($clock);
    ...
    public function testValidInnIsFetchedFromDadataAndCached(): void
    {
        ...
        $strategy = new DadataInnValidationStrategy(
...
final class FakeInnValidationCache implements InnValidationCache
{
